...
# see v2 for what this used to look like
    ...
    parser.add_example("Example 1: Convert all .a26 binary files in the current directory to hexadecimal.")
    parser.add_example("bin2hex-hex2bin-combined-v3.py -allbin a26 -b2h .")

    parser.add_example("Example 2: Convert binary files listed in 'input_files.txt' (with .a26 extension) to hexadecimal.")
    parser.add_example("bin2hex-hex2bin-combined-v3.py -allbin a26 -b2h -t input_files.txt")
